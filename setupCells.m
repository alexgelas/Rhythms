...
% Produces a list of cells for the network, specifying their
% characteristics, by looking up the cell types specified in cellType
% (created in setupNetwork.m) in the database of cell type characteristics (created by setupCellTypes.m).
